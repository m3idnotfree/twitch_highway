...
//
//     let mut create_eventsub = CreateEventSub::new(
...
//         Transport::websocket(""),
//     );
//     create_eventsub.condition.user_id = Some("1234".to_string());
...
// // #[cfg(feature = "eventsub")]
// // #[test]
// // fn create_eventsub_condition_dropentitlement_grant_condition() {
// //     use std::collections::HashMap;
// //
// //     use asknothingx2_util::oauth::{AccessToken, ClientId};
// //     use twitch_highway::{
...
// //     condition.insert("user_id", "1234");
// //
// //     let mut create_eventsub = CreateEventSub::drop_entitlement_grant_condition(
// //         AccessToken::new("cfabdegwdoklmawdzdo98xt2fo512y".to_string()),
// //         ClientId::new("uo6dggojyb8d6soh92zknwmi5ej1q2".to_string()),
// //         SubscriptionTypes::DropEntitlementGrant,
// //         Transport::webhook("https://example.com/webhooks/callback").set_secret("s3cRe7"),
// //         "9001".to_string(),
// //     );
// //     create_eventsub.condition.category_id = Some("9002".to_string());
// //     create_eventsub.condition.campaign_id = Some("9003".to_string());
// //     let expected_headers = expect_headers!(json);
// //     let expected_json = "{\"type\":\"drop.entitlement.grant\",\"version\":\"1\",\"condition\":{\"organization_id\":\"9001\",\"category_id\":\"9002\",\"campaign_id\":\"9003\"},\"transport\":{\"method\":\"webhook\",\"callback\":\"https://example.com/webhooks/callback\",\"secret\":\"s3cRe7\"},\"is_batching_enabled\":true}".to_string();
// //
// //     expect_APIRequest!(
// //         POST,
// //         expected_headers,
