...
api_test!(get_custom_reward | api | { api.get_custom_reward(&BroadcasterId::from("274637212")) });
...
api_test!(
    get_custom_reward as get_custom_reward2 | api | {
...
api_test!(
    get_custom_reward as get_custom_reward3 | api | {
        api.get_custom_reward(&BroadcasterId::from("274637212"))
...
api_test!(
    get_custom_reward_redemption as get_custom_reward_redemption2 | api | {
        api.get_custom_reward_redemption(
            &BroadcasterId::from("274637212"),
            &RewardId::from("92af127c-7326-4483-a52b-b0da0be61c01"),
        )
...
api_test!(
    update_custom_reward as update_custom_reward2 | api | {
        api.update_custom_reward(
            &BroadcasterId::from("274637212"),
            &RewardId::from("92af127c-7326-4483-a52b-b0da0be61c01"),
        )
